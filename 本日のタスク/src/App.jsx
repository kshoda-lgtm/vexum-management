  ...
  return (
    <div className="min-h-screen bg-gray-100 pb-20">
      <div className="max-w-2xl mx-auto">
        {/* ヘッダー */}
        <div className="bg-blue-500 text-white py-6 px-4 sticky top-0 z-20 shadow-md">
        ...
        {/* タスク追加フォーム */}
        <form onSubmit={handleAddTask} className="bg-white p-4 shadow-md sticky top-[120px] z-10">
        ...
        <div className="p-4 space-y-4">
          ...
          {tasks.length === 0 && (
            <div className="text-center text-gray-500 mt-12 py-12 bg-white rounded-lg shadow">
              <div className="text-6xl mb-4">📝</div>
              <div className="text-lg font-bold mb-2">タスクがありません</div>
              <div className="text-sm">上のフォームから追加してください</div>
            </div>
          )}
        </div>
      </div>
